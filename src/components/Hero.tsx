  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-primary via-orange to-primary px-4 py-20">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-40 right-20 text-5xl opacity-15 animate-float" style={{ animationDelay: '1s' }}>
        ...
        <div className="absolute bottom-32 left-16 text-4xl opacity-20 animate-float" style={{ animationDelay: '2s' }}>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-right space-y-8 animate-slide-up order-2 lg:order-2">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-end pt-6">
              <Button 
                size="lg" 
                className="text-xl font-black bg-accent text-white hover:scale-105 transition-all shadow-2xl hover:shadow-accent/50 rounded-full px-10 py-7 border-4 border-secondary"
              >
                شوف المراجعات
              </Button>
              <Button 
                size="lg" 
                variant="outline"
                className="text-xl font-black border-4 border-secondary text-secondary bg-sky/50 hover:bg-sky hover:text-secondary-foreground rounded-full px-10 py-7 backdrop-blur-sm"
              >
