      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="grid md:grid-cols-2 gap-16 md:gap-24 items-center">
          ...
          <div className="flex flex-col items-end space-y-10 animate-slide-up order-1 md:order-2 w-full">
            ...
            <p className="text-2xl leading-relaxed font-sans font-medium drop-shadow-md text-gray-50 text-right mr-[76px]">
          ...
          {/* Image */}
          <div className="relative order-2 md:order-1 animate-bounce-in md:absolute md:-left-[13rem] lg:-left-[23rem] md:top-1/2 md:-translate-y-1/2 md:-mt-[113px]">
            <div className="relative w-full max-w-5xl">
              <img alt="Ahmed Mango Mascot" className="w-full h-auto drop-shadow-2xl animate-float scale-[0.4] ml-[190px]" src="/lovable-uploads/f97809ec-51a9-476f-ac07-23c98169f96d.png" />
              {/* Glow Effect */}
