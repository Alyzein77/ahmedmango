    ...
    <section id="hero" className="relative w-full overflow-hidden font-poppins pt-6 pb-16 sm:pt-10 sm:pb-20">
      ...
      <div className="relative z-10 w-full flex flex-col items-center px-4 max-w-md mx-auto">
        ...
        <div className="relative flex items-center justify-center mb-4 sm:mb-6">
          ...
          <img 
            alt="Ahmed Mango" 
            className="relative w-[160px] h-[160px] sm:w-[200px] sm:h-[200px] object-cover object-center rounded-full drop-shadow-xl" 
        ...
        <div className="flex flex-col items-center text-center">
          <h1 
            className="text-2xl sm:text-3xl leading-none text-[#1A1349] font-extrabold tracking-tight mb-2"
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-2 sm:gap-3 mt-4 mb-4 sm:mb-6 w-full">
          <Button 
            className="h-11 sm:h-10 px-5 w-full sm:w-auto sm:min-w-[140px] text-xs font-bold rounded-full shadow-lg hover:scale-105 active:scale-95 transition-all duration-300 border-0"
            style={{
          ...
          <Button 
            className="h-11 sm:h-10 px-5 w-full sm:w-auto sm:min-w-[140px] text-xs font-bold rounded-full hover:scale-105 active:scale-95 transition-all duration-300 bg-white border border-[#1A1349]/20"
            style={{
              color: '#1A1349',
        ...
        <div className="flex justify-center items-start gap-4 sm:gap-5">
          <div className="text-center">
            ...
            <div className="text-xs sm:text-sm font-semibold text-[#1A1349]" style={{ fontFamily: 'Poppins, sans-serif' }}>
              +٥٠٠ ألف
            </div>
