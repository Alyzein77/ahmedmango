  ...
  return <section id="hero" className="relative w-full overflow-hidden font-poppins pt-6 pb-16 sm:pt-10 sm:pb-20">
      ...
      <div className="relative z-10 w-full flex flex-col items-center px-4 max-w-md mx-auto">
        ...
        <div className="relative flex items-center justify-center mb-4 sm:mb-6">
          ...
          {/* Man image */}
          <img alt="Ahmed Mango" className="relative w-[160px] h-[160px] sm:w-[200px] sm:h-[200px] object-cover object-center rounded-full drop-shadow-xl mt-6" src="/lovable-uploads/c71f33e6-ec3e-4a14-8912-886a27f8246d.png" />
        </div>
