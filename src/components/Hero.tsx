        ...
        <div className="grid md:grid-cols-2 gap-16 md:gap-24 items-center">
          ...
          <div className="text-center md:text-left space-y-10 animate-slide-up order-1 md:order-2">
            ...
            <h1 className="text-7xl md:text-9xl font-black leading-tight">
              ...
              <span className="block bg-gradient-to-r from-primary via-orange-500 to-primary bg-clip-text text-transparent animate-pulse-glow md:text-9xl font-sans text-right font-medium text-7xl px-0 my-[31px] mx-0">
                2استكا أو فاستكا؟
              </span>
            </h1>
