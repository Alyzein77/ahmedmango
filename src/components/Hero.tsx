      ...
      <div className="relative z-10 w-full flex flex-col items-center px-4 max-w-md mx-auto">
        ...
        <div className="flex flex-col justify-center items-center gap-3 mt-4 mb-4 sm:mb-6 w-full">
          <Button 
            ...
            className="h-11 px-6 w-[180px] text-sm font-black rounded-lg bg-accent text-accent-foreground border-2 border-foreground shadow-bold hover:shadow-bold-sm active:translate-x-[2px] active:translate-y-[2px] active:shadow-none transition-all duration-150 uppercase tracking-wide"
          >
            العب واكسب جوائز
          </Button>
