      ...
      <div className="container mx-auto px-3 sm:px-4 bg-[#9ad8ea]">
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="hidden md:flex items-center gap-4 lg:gap-6">
            ...
            <Button className="text-sm font-black uppercase tracking-wide rounded-lg" onClick={() => window.open('https://www.kharbsh.com/ahmed-mango/campaign/3775071ae46c47f4b41f5688e66406a0', '_blank', 'noopener,noreferrer')}>
              🎮 ابدأ اللعب
            </Button>
          </div>
