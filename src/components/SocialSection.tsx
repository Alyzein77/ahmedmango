  ...
  return <section id="social" className="py-12 sm:py-16 px-3 sm:px-4 bg-orange">
      <div className="container mx-auto max-w-6xl text-center">
        ...
        <div className="flex justify-center items-center gap-4 sm:gap-6">
          {socialPlatforms.map((platform, idx) => <a key={idx} href={platform.url} target="_blank" rel="noopener noreferrer" className={`w-14 h-14 sm:w-16 sm:h-16 ${platform.color} rounded-lg border-2 border-foreground flex items-center justify-center transition-all duration-150 hover:shadow-bold-sm hover:translate-x-[2px] hover:translate-y-[2px] shadow-bold`} aria-label={platform.name}>
