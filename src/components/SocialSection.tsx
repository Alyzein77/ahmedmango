  ...
  return (
    <section id="social" className="py-12 sm:py-16 px-3 sm:px-4 bg-gradient-to-b from-background to-primary/5">
      <div className="container mx-auto max-w-6xl text-center">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-black mb-6 font-lalezar text-secondary">
          تابعني على السوشيال 📱
        </h2>
        <div className="flex justify-center items-center gap-6 sm:gap-8">
          {socialPlatforms.map((platform, idx) => (
            <a
              ...
              className={`w-14 h-14 sm:w-16 sm:h-16 ${platform.color} rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-lg`}
